<template>
	<div class="main-container">
		...
		<div class="flex-row-aeb">
			...
			<span class="user-identity">{{ $t("User identity") }}</span>
			<div class="rectangle"><span class="level-i">Level I</span></div>
		</div>
...
.ellipse {
	...
	height: 82px;
	margin: 4px 0 0 4px;
	background: url(https://codia-f2c.s3.us-west-1.amazonaws.com/image/2025-09-11/dTCTuFgYit.png) no-repeat center;
